...
If you expected more activity from me, keep in mind that GitHub is not the only software forge that I use. I am also active across [GitLab](https://gitlab.com/TechnologyClassroom), [Codeberg](https://codeberg.org/JShelter/webextension), [Sourcehut](https://sr.ht/), and various self-hosted forge instances.
